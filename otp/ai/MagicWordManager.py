...
class MagicWordManager(DistributedObject.DistributedObject):
    ...
    def identifyDistributedObjects(self, name):
        ...
        for obj in list(self.cr.doId2do.values()):
            ...
            if str.lower(name) == lowerName or str.lower(className) == lowerName or str.lower(className) == 'distributed' + lowerName:
    ...
    def showfont(self, fontname):
        fontname = str.strip(str.lower(fontname))
    ...
    def identifyAvatar(self, name):
        ...
        lowerName = str.lower(name)
        for av in Avatar.Avatar.ActiveAvatars:
            if isinstance(av, self.GameAvatarClass) and str.strip(str.lower(av.getName())) == lowerName:
                return av.doId
