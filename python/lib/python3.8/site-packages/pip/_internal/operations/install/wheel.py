...
def get_entrypoints(filename):
    ...
    console = dict(_split_ep(v) for v in list(console.values()))
    gui = dict(_split_ep(v) for v in list(gui.values()))
    return console, gui
...
def message_about_scripts_not_on_PATH(scripts):
    ...
    warn_for = {
        parent_dir: scripts for parent_dir, scripts in list(grouped_by_dir.items())
...
def install_unpacked_wheel(
    ...
    scripts_to_generate.extend(
        '%s = %s' % kv for kv in list(console.items())
    )
