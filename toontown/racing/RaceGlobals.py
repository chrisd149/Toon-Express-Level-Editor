"""
RaceGlobals modules: defines constants used across the Kart racing classes.
"""
...
def getNextRaceInfo( prevTrackId, genreString, padId ):
    ...
    if trackList.count(prevTrackId) == 0:
        ...
        # find the next track in the list.  Note, this will fail
        # if the same track is listed twice
...
# Cups - these are really trophies
TenTrophyCup = 30
TwentyTrophyCup = 31
ThirtyTrophyCup = 32
